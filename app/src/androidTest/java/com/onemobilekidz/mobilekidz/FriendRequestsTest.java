...
public class FriendRequestsTest extends ActivityInstrumentationTestCase2<FriendRequests> {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        friendRequests = getActivity();

        homeButton = (Button) friendRequests.findViewById(R.id.homeButton);

        friendsButton = (Button) friendRequests.findViewById(R.id.friendsButton);

        babysittingButton = (Button) friendRequests.findViewById(R.id.babysittingRequestButton);
